                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="product-thumbs">
                                <carousel :dots="false" :nav="false" :autoplay="true" :loop="true" class="product-thumbs-track ps-slider">
                                    <div class="pt " @click="changesImage(thumbs[0])" :class="thumbs[0] == gambar_default ? 'active':'' ">
                                        <img src="img/mickey1.jpg" alt="" />
                                    </div>

                                    <div class="pt"  @click="changesImage(thumbs[1])" :class="thumbs[1] == gambar_default ? 'active':'' "> 
                                        <img src="img/mickey2.jpg" alt="" />
                                    </div>

                                    <div class="pt"  @click="changesImage(thumbs[2])" :class="thumbs[2] == gambar_default ? 'active':'' ">
                                        <img src="img/mickey3.jpg" alt="" />
                                    </div>

                                    <div class="pt"  @click="changesImage(thumbs[3])" :class="thumbs[3] == gambar_default ? 'active':'' ">
                        ...
                        <div class="col-lg-6">
                            <div class="product-details text-left">
                                ...
                                <div class="quantity">
                                    <router-link to="/carts" ><a href="" class="primary-btn pd-cart">Add To Cart</a></router-link>
                                </div>
                            </div>
                        </div>
                    </div>
